<template>
    <div style="padding: 20px;min-width: 450px;">
        <div class="line" style="margin-bottom: 20px;">
            <div class="label require">角色名称</div>
            <CmsInput style="flex:1;" placeholder="请输入角色名称" v-model="form.name"></CmsInput>
        </div>
        <div class="line" style="margin-bottom: 20px;">
            <div class="label">描述</div>
            <CmsInput style="flex:1;" placeholder="请输入角色描述" v-model="form.description"></CmsInput>
        </div>
        <div class="line" style="margin-bottom: 20px;">
