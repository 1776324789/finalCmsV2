<template>
    <div class="line">
        ...
        <div class="labelName blockLine" style="flex:1;text-indent: 10px;">名称</div>
        <div class="index blockLine" style="width: 120px;">图标</div>
        <div class="index blockLine" style="width: 200px;">目标路由</div>
