<template>
    <div class="line">
        ...
        <div class="blockLine" style="font-weight: 350;display: flex;text-indent: 5px;width:200px;">
            {{ data.description || '-' }}
        </div>
        ...
        <div class="menuBlock">
            <div class="lineButton permissionButton" @click="permissionHandel">
                <span class="icon-key-2-line"></span>
            </div>
...
const emit = defineEmits(["edit", "change", "delete", "permission"]);
