<template>
    <div class="line">
        ...
        <div class="blockLine" style="font-weight: 350;display: flex;text-indent: 5px;flex: 1;align-items: center;">
            {{ data.name }}
            <span v-if="!data.target" class="icon-folder-fill"
                style="margin-right: 8px;color: #ff9800;font-size: 16px;"></span>
        </div>
        <div class="index blockLine" style="width: 120px;">
            <span :class="data.icon" style="font-size: 18px;"></span>
        </div>
        <div class="index blockLine" style="width: 200px;">{{ data.target || '-' }}</div>
